...
- During an outage (primary down), the CSI driver only responds to publish requests issued to existing `PersistentVolumes` in an RCG. No provisioning requests will be serviced until the primary is back.
